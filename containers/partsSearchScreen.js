        ...
        topContent={
          <View style={styles.container}>
            <Header androidStatusBarColor="rgba(210, 10, 15, 1)" style={styles.navigationBarStyle}>
              ...
              <Title style={styles.navHeaderTitle}>{I18n.t("Part#Search")}</Title>
            ...
            <View style={styles.container, {marginTop: 20}}>
              <Card style={{flex: 1, paddingTop: 10, flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
